...
void loop() { 
    ...
    if ( Serial.available() ) {
        ...
        switch ( ch ) {
            case '1':
                display.displayStatus("Fq");
                IncrementFrequencyTest();
                break;
            case '2':
                display.displayStatus("Cycle");
                CycleWaveformsTest();
                break;  
            case '3':
                display.displayStatus("Switch");
                SwitchFrequencyRegisterTest();
                break; 
            case '4':
                display.displayStatus("Phase");
                PhaseTest();
                break;
            case '5':
                display.displayStatus("Read");
                RequestedvsProgrammedValues();
                break;
            case '6':
                display.displayStatus("Enable");
                outputOn = ! outputOn;
